...
%        \GraphInit[vstyle=Hasse]
  ...
  \begin{columns}
    ...
    % \end{block}
      ...
      \begin{block}{Módulo de Specht $S^{\lambda}$}
        ...
        $\mathbb{C}$-espacio vectorial generado por elementos llamados
        politabloides $e_{t}$ (los cuales mapean cada tablero al
        tablero que fija sus renglones), donde $t$ es tomado sobre todos los tableros de forma
        $\lambda$.
 ...
 %\begin{block}{Lema}
      ...
      \begin{block}{Teorema de Bouc}
        ...
        $\widetilde H_{k-1}(G_{n};\mathbb{C})$ fue dada por Bouc. Para
