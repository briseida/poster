...
\usetheme{RJH}
\usepackage[orientation=portrait,size=a0,scale=1.32,debug]{beamerposter}
...
\begin{frame}{}
  \begin{block}{Resumen}
    ...
    \begin{minipage}{0.15\linewidth}
      ...
      \begin{tikzpicture}
%        \GraphInit[vstyle=Hasse]
        \grEmptyCycle[RA=0.9,rotation=-90]{5}
        \grEmptyCycle[RA=1.7,prefix=w,rotation=-90]{5}
        \grCycle[RA=3.5,prefix=z,rotation=90]{5}
    ...
    \begin{column}{0.5\textwidth}
     ...
     \end{block}
      ...
      \begin{block}{Ejemplo}
        \begin{minipage}{0.3\linewidth} 
          \centering
          \begin{tikzpicture}[x=3 cm,y=3 cm]
...
\begin{block}{}
   \begin{minipage}{0.46\linewidth} \quad
       \begin{center}
       \begin{tikzpicture}
         \GraphInit[vstyle=Shade] \Vertex[x=0,y=0,Math]{a}
         \grEmptyCycle[RA=2.5,prefix=b]{6}
         \grEmptyCycle[RA=5.2,prefix=c]{24}
         \EdgeFromOneToAll{a}{b}{}{6} \EdgeInGraphMod*{b}{6}{1}{0}{2}
   ...
   \begin{minipage}{0.43\linewidth} 
      \begin{center}
       \begin{tikzpicture}
         ...
         \grCycle[RA=2,prefix=a,rotation=-90]{3}
         \grEmptyCycle[RA=5.2,prefix=b,rotation=-10]{12}
